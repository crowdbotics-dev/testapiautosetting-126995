...
## Project Structure
    ...
    ├── testapiautosetting_126995  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126995`
...
2. Clone this repo and `cd testapiautosetting_126995`
